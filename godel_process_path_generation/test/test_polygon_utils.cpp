...
TEST(PolygonSegment, simple)
{
   ...
   *  p3 *
   */
  godel_process_path::PolygonPt p0(0., 0.),
                                p1(1., 0.),
                                p2(0., 1.),
                                p3(0., -1),
                                p4(1., 1.);

  godel_process_path::polygon_utils::PolygonSegment
                                s01(p0,p1),
                                s02(p0,p2),
                                s23(p2,p3),
                                s34(p3,p4);
...
TEST(PolygonSegment, complex)
{
   ...
   *  *         p4
   */
  godel_process_path::PolygonPt p0(0.035726, 0.017804),
                                p1(0.038726, 0.021804),
                                p2(0.038726, 0.017804),
                                p3(0.032726, 0.017804),
                                p4(0.038726, 0.014804);
