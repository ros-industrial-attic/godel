...
#include <motoman_sia20d_descartes/motoman_sia20d_robot_model.h>
...
using namespace motoman_sia20d_ikfast_manipulator;

namespace motoman_sia20d_descartes
{
MotomanSia20dRobotModel::MotomanSia20dRobotModel()
    : world_to_base_(Eigen::Affine3d::Identity()), tool_to_tip_(Eigen::Affine3d::Identity())
{
}

bool MotomanSia20dRobotModel::initialize(const std::string& robot_description,
...
bool MotomanSia20dRobotModel::getAllIK(const Eigen::Affine3d& pose,
...
PLUGINLIB_EXPORT_CLASS(motoman_sia20d_descartes::MotomanSia20dRobotModel,
