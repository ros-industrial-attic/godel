#include <godel_process_execution/motoman_keyence_process_service.h>
...
int main(int argc, char** argv)
{
  ...
  godel_process_execution::ProcessExecutionService path_executor("motoman_keyence_process_execution", sim_name, real_name, nh);
