 ...
 */
bool ProcessPlanningManager::handleQuelltechPlanning(godel_msgs::QuelltechProcessPlanning::Request& req,
                                                   godel_msgs::QuelltechProcessPlanning::Response& res)
{
  quelltech_model_->setCheckCollisions(true);
  ...
  if (generateMotionPlan(quelltech_model_, process_points, moveit_model_, quelltech_group_name_,
