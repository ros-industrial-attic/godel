...
public:
  ProcessPlanningManager(const std::string& world_frame, const std::string& blend_group,
                         const std::string& blend_tcp, const std::string& quelltech_group,
                         const std::string& quelltech_tcp, const std::string& robot_model_plugin);

  bool handleBlendPlanning(godel_msgs::BlendProcessPlanning::Request& req,
                           godel_msgs::BlendProcessPlanning::Response& res);

  bool handleQuelltechPlanning(godel_msgs::QuelltechProcessPlanning::Request& req,
                             godel_msgs::QuelltechProcessPlanning::Response& res);

private:
  descartes_core::RobotModelPtr blend_model_;
  descartes_core::RobotModelPtr quelltech_model_;
  ...
  std::string quelltech_group_name_;
};
}
