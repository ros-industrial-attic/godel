...
#ifndef ABB_IRB6640_ROBOT_MODEL_H
#define ABB_IRB6640_ROBOT_MODEL_H
...
{
  class AbbIrb6640RobotModel: public descartes_moveit::MoveitStateAdapter,
    public irb6640_ikfast_manipulator_plugin::IKFastKinematicsPlugin
{
  public:

    AbbIrb6640RobotModel();
    ...
    {
      descartes_core::RobotModelPtr ptr (new AbbIrb6640RobotModel());
