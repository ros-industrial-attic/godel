...
#include <abb_irb6640_descartes/abb_irb6640_robot_model.h>
...
using namespace irb6640_ikfast_manipulator_plugin;

namespace abb_irb6640_descartes
{
  AbbIrb6640RobotModel::AbbIrb6640RobotModel():
  ...
  bool AbbIrb6640RobotModel::initialize(const std::string& robot_description, const std::string& group_name,
                                    const std::string& world_frame,const std::string& tcp_frame)
  {
    MoveitStateAdapter::initialize(robot_description,group_name,world_frame,tcp_frame);
    irb6640_ikfast_manipulator_plugin::IKFastKinematicsPlugin::initialize(robot_description, group_name, MOTOMAN_SIA20D_BASE_LINK,
  ...
  bool AbbIrb6640RobotModel::getAllIK(const Eigen::Affine3d &pose,
...
PLUGINLIB_EXPORT_CLASS(abb_irb6640_descartes::AbbIrb6640RobotModel,descartes_core::RobotModel)
